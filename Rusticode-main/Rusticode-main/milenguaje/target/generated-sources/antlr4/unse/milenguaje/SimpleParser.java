...
public class SimpleParser extends Parser {
	...
	private static final String[] _LITERAL_NAMES = {
		null, "'start'", "'end'", "'int'", "'real'", "'char'", "'bool'", "'if'", 
		"'endif'", "'while'", "'endwhile'", "'?'", "'+'", "'-'", "'*'", "'>'", 
		"'<'", "'>='", "'<='", "'!='", "'&&'", "'||'", "'=='", "'¬'", "'<<'", 
		"':'", "'::'", "';'", "'('", "')'", "'{'", "'}'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, "START", "END", "DEFINT", "DEFREAL", "DEFCHAR", "DEFBOOL", "IF", 
		"ENDIF", "WHILE", "ENDWHILE", "QUERY", "SUM", "REST", "MULT", "HIGH", 
		"LESS", "HEQL", "LEQL", "UNEQL", "AND", "OR", "EQUAL", "NEGT", "ASSIG", 
		"DOUPOINT", "DDPOINT", "SEMICOLON", "OPENBRACKET", "CLOSEDBRACKET", "OPENKEY", 
		"CLOSEKEY", "ENTERO", "REAL", "BOOL", "CHAR", "VAR", "SW", "DEFREAl", 
		"DDPOIN", "SEMICON", "CLOSEBRACKET"
	};
	...
	public static class Inicio_finContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitInicio_fin(this);
	...
	public static class If_sentenciaContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitIf_sentencia(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class While_sentenciaContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitWhile_sentencia(this);
			else return visitor.visitChildren(this);
		}
	}
